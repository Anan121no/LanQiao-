...
这题有点恶心,把8个块记录为一个数组，每个块有6个面，所以块也是个数组，所以开个二维数组模拟，
每次操作有3种，向前顺时针,向上顺时针 ,向左顺时针,hhha，看的有点迷惑了把，不知道大家有没发现玩魔方的大佬玩魔方的时候，
只对一个角只往3个方向旋转呢，没错，我们就用bfs记录下所有的状态，大概的思路是这样的= =
————————————————
